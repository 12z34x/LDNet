...
class DroneCC(Dataset):
    def __init__(self, opt, mode):
        ...
        self.aug_root = osp.join(self.data_dir, "augment")#augment
    ...
    def __getitem__(self, index):
        ...
        label_path = osp.join(self.labels_dir, dir_name+'_'+img_name[:-4]+'.hdf5')#get label.hdf5 
