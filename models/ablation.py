...
class AblaNet(nn.Module):
    def __init__(self, opt):
        super(AblaNet, self).__init__()
        #***********SANet***************
        in_channels = 512
        use_bn=True
        ...
        part_channels=64#64
        self.atrous_conv = nn.Conv2d(part_channels*2, part_channels*2, kernel_size=3,
    ...
    def forward(self, input):
        ...
        # attention=torch.clamp((attention+1)/2,min=0.90,max=1.10)
        ...
        x1=self.atrous_conv(x1)
        high2_level_feat= self.atrous_conv(x1)#128 channels
        ...
        density = self.density(high2_level_feat)#high2_level_feat
