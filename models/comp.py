...
class ComNet(nn.Module):
    def __init__(self, opt):
        ...
        self.region = nn.Sequential(nn.Conv2d(part_channels*2, 128, kernel_size=3, stride=1, padding=1, bias=False),
                                    #  SELayer(128),
                                     nn.BatchNorm2d(128),#!!!!
                                     nn.ReLU(),
    ...
    def forward(self, input):
        ...
        region = self.region(x1)#high1_level_feat)
        density = self.density(x1)#high2_level_feat)
