...
import random
from dataloaders.datasets import ucf
...
class Trainer(object):
    def __init__(self, mode):
        ...
        self.scheduler = optim.lr_scheduler.MultiStepLR(
            self.optimizer,
            milestones=[4,16,32,64,128,200,256],#round(opt.epochs * x) for x in opt.steps], 在[12,24,36,48,60,72]
            gamma=opt.gamma)
